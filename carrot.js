    ...
    bot.on('message', async (message) => {
        ...
        if (messageText.includes('[$] Ваш баланс:')) {
            ...
            for (let i = firstInventorySlot; i <= lastInventorySlot; i++) {
                if (bot.inventory.slots[i] && bot.inventory.slots[i].name === 'golden_carrot') count++
            }
    ...
    if (!bot.ahFull) {
        try {
            ...
            for (let sellSlot = firstSellSlot; sellSlot <= lastInventorySlot; sellSlot++) {
                ...
                if (item && item?.name != 'golden_carrot') countPomoi++
                ...
                if (!item) {
                    ...
                    for (let invSlot = firstInventorySlot; invSlot <= lastInventorySlot; invSlot++) {
                        ...
                        if (!invItem || invItem?.name !== 'golden_carrot') continue;
                    ...
                    items[sellSlot - firstSellSlot] = item?.name === 'golden_carrot';
                }
            }
