...
const data = {
  ...
  '1.21.1': {
    ...
    itemsTextures: require('./minecraft-assets/data/1.21.1/items_textures'),
  ...
  '1.21.4': {
    blocksTextures: require('./minecraft-assets/data/1.21.4/blocks_textures'),
    itemsTextures: require('./minecraft-assets/data/1.21.4/items_textures'),
