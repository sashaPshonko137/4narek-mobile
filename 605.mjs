...
// Массив с ботами
const bots = [
    { username: 'aleshaNaGazu', password: 'ggggg', anarchy: 605, type: '4narek', inventoryPort: 3000, balance: 0, msgID: 0, item: 'netherite sword', itemPrices:items, },
    { username: 'bolvanBATOMA', password: 'gggggg', anarchy: 605, type: '4narek', inventoryPort: 3001, balance: 0, msgID: 0, item: 'netherite sword', itemPrices:items, },
    { username: 'DEDboltoed', password: 'ggggg', anarchy: 605, type: '4narek', inventoryPort: 3002, balance: 0, msgID: 0, item: 'netherite sword', itemPrices:items, }
];
let workers = [];
